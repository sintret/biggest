...
class GoogleMapsSlider extends StatefulWidget {
  GoogleMapsSlider({Key? key}) : super(key: key);

  @override
  _GoogleMapsSliderState createState() => _GoogleMapsSliderState();
}

class _GoogleMapsSliderState extends State<GoogleMapsSlider> {
