                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_image.png",
                        height: 45.0,
                      ),
                      Text(
                        "Photo",
                    ...
                    InkWell(
                      ...
                      child: Column(children: <Widget>[
                        Image.asset(
                          "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_video.png",
                          height: 45.0,
                        ),
                        Text(
                          "Video",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_microphone.png",
                        height: 45.0,
                      ),
                      Text(
                        "Voice",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_file.png",
                        height: 45.0,
                      ),
                      Text(
                        "File",
                    ...
                    Column(children: <Widget>[
                      Image.asset(
                        "lib/Screen/FullApps/VinckierFoods/Assets/image/icon_monitor.png",
                        height: 45.0,
                      ),
                      Text(
                        "Screen",
          ...
          Padding(
            ...
            child: Center(
              child: Opacity(
                  opacity: 0.5,
                  child: Image.asset(
                    "lib/Screen/FullApps/VinckierFoods/Assets/image/noMessage.png",
                    height: 200.0,
                  )),
            ),
          ),
