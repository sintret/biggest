...
class _T4_transactionsState extends State<T4_transactions> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            /// List card today
            ///
            _cardToday(Colors.lightBlueAccent, Icons.monetization_on, "Salary",
                "Monthly Salary", "+\$3000", Colors.green),
            _cardToday(Colors.yellow, Icons.phone, "Call Phone Bill",
                "Monthly Payment", "-\$50", Colors.redAccent),
            _cardToday(Colors.deepPurpleAccent, Icons.home, "Home Payment",
                "Monthly Payment", "-\$300", Colors.redAccent),
            SizedBox(
              height: 30.0,
            )
          ],
  ...
  ///
  Widget _cardToday(Color _backgroundIcon, IconData _icon, String _title,
      String _subTitle, String _value, Color _textColor) {
    return Padding(
