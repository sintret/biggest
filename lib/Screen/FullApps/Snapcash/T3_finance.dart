  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            card("lib/Screen/FullApps/Coinbase/Assets/bils_finance.png",
                "Bills", "3 bills not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/doctor_finance.png",
                "Doctor", "doctor not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/hangout_finance.png",
                "Hangout", "food not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/lifeStyle_finance.png",
                "LifeStyle", "2 t-shirt not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/workout_finance.png",
